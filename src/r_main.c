...
void R_Setup(void)
{
   ...
   *(int *)0xf0226c = *(int *)0xf02268 = 0; /* pattern compare */
   ...
   if(player->powers[pw_ironfeet] > 60 || (player->powers[pw_ironfeet]&4))
      shadey += 7;

   if(player->powers[pw_strength] && (player->powers[pw_strength]< 64))
...
extern int ref1_start;
extern int ref2_start;
extern int ref3_start;
extern int ref4_start;
extern int ref5_start;
extern int ref6_start;
